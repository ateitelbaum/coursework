...
#Question 2b
Compute the 'di???s'. Check to see if each outcome metric changed in a statistically signi???cant way between the two interviews.
```{r Question 2b}
...
#Question 2c
Now compute the "di???-in-di???" via the regression method
```{r regression method}
